...
const atcPos = ["FTW", "DFW", "REG", "DAL", "OKC", "LBB", "ABI", "ADM", "ADS", "AFW", "BAD", "CNW", "CSM", "DTN", "DYS", "FSI", "FWS", "GGG", "GKY", "GPM", "GRK", "GVT", "GYI", "HLR", "HQZ", "HOB", "LAW", "LTS", "MAF", "MLU", "NFW", "OUN", "PWA", "RBD", "SHV", "SJT", "SPS", "TIK", "TKI", "TXK", "TYR"];
const airports = ["KDFW","KDAL","KFTW","KOKC","KLBB","KABI","KADM","KADS","KAFW","KBAD","KCNW","KCSM","KDTN","KDYS","KFSI","KFWS","KGGG","KGKY","KGPM","KGRK","KGVT","KGYI","KHLR","KHQZ","KHOB","KLAW","KLTS","KMAF","KMLU","KNFW","KOUN","KPWA","KRBD","KSHV","KSJT","KSPS","KTIK","KTKI","KTXK","KTYR"];
const neighbors = ['ZAB', 'ZME', 'ZHU', 'ZKC'];
